...
#if defined(NDEBUG)
# error "Fullintegritycoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xee0eb1c47d212e75d71e39afd34e4ba745e9965ff7a7e86f955c8263320467dc");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Fullintegritycoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Fullintegritycoin Signed Message:\n";
...
{
    // Fullintegritycoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 2102400); // Fullintegritycoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Fullintegritycoin: 3.5 days
static const int64 nTargetSpacing = 1 * 60; // Fullintegritycoin: 1 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Fullintegritycoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Fullintegritycoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Fullintegritycoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xee0eb1c47d212e75d71e39afd34e4ba745e9965ff7a7e86f955c8263320467dc");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "10/18/14, Disaster of Our Generation";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1413948033;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2361597967;
        ...
        assert(block.hashMerkleRoot == uint256("0x2f2860afea312dad5d14c5628365dc9fcbd2cae1aef50ab7dc171465c7ae6554"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x46, 0x55, 0x4c, 0x4c }; // Fullintegritycoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("FullintegritycoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("FullintegritycoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("FullintegritycoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("fullintegritycoin-miner");
    ...
    try { loop {
        ...
        printf("Running FullintegritycoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("FullintegritycoinMiner terminated\n");
        throw;
    }
}
